...
while counter<100:
    ...
    try:
        ...
        if counter == 1:
            print("count==",count_defects, prev)
            if count_defects == 0:
                prev = 0
            ...
            elif count_defects == 1 and prev == 1:
                print("Win+1")
                prev = 0

            elif count_defects == 2 and prev == 2:
                print("Win+2")
                prev = 0
            
            elif count_defects == 3 and prev == 3:
                print("alt + f4")
                prev = 0

            elif count_defects == 4 and prev == 4:
                print("spacebar")
                prev = 0
